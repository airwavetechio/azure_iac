...
param subnetStorageID string
param privateDnsZonesStorageID string
...
resource privateEndpoint 'Microsoft.Network/privateEndpoints@2022-07-01' = {
  ...
  properties: {
    ...
    customNetworkInterfaceName: 'pe-${storageAccountName}-nic'
    subnet: {
      id: subnetStorageID
    }
    ipConfigurations: []
...
resource privateEndpointsStorageDNS 'Microsoft.Network/privateEndpoints/privateDnsZoneGroups@2022-07-01' = {
    ...
    privateDnsZoneConfigs: [
      {
        ...
        properties: {
          privateDnsZoneId: privateDnsZonesStorageID
        }
      }
    ]
  }
...
output privateEndpointsStorageID string = privateEndpoint.id
